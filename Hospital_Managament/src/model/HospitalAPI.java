...
public class HospitalAPI extends HttpServlet{
	...
	{
		String output = hostObj.insertHospital(request.getParameter("hospitalCode"),      
				...
				request.getParameter("hospitalTel")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		Map paras = getParasMap(request); 
		 ...
		 String output = hostObj.updateHospital(paras.get("hidItemIDSave").toString(),     
				 ...
				 paras.get("hospitalTel").toString()); 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = hostObj.deleteHospital(paras.get("hospitalID").toString()); 
